...
uint64_t mulhsu(uint64_t a, uint64_t b) {
  unsigned __int128 val = (__int128)((int64_t)a) * (unsigned __int128)((int64_t)b);
  return val >> 64;
}

uint64_t mulhu(uint64_t a, uint64_t b) {
  unsigned __int128 val = (unsigned __int128)((int64_t)a) * (unsigned __int128)((int64_t)b);
  return val >> 64;
}
...
uint64_t divu(uint64_t a, uint64_t b) {
  ...
  uint64_t val = (uint64_t)a / (uint64_t)b;
